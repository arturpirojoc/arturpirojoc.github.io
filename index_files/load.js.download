...
if (!_tb_dis) {
    ...
    var _pmpmk = pm_ppy + '/pmk-201808001.9.js';
    var _pmasync = true;
    ...
    'sx': '//meta[@name="tbi-vertical"]/@content',
    'at': '//meta[@property="author"]/@content',
    'atd': [" and ", " And "],
    'opd': ["section"]
};
...
var _tb_vpx = [{
        'xpath': '//div[contains(@class, "oo-player-container")]',
        'attr': 'div'
    },
    {
        'xpath': '//div[@id="content"]//div[contains(@id,"video")]//div[@class="jw-media jw-reset"]/video',
        'attr': 'video'
    },
    {
        'xpath': '//div[@id="content"]//div[contains(@class,"twitter-video")]//iframe',
        'attr': 'iframe'
    }
];
...
_tb_ext_xp = {
    'facebook': [{
        'xpath': '//div[contains(@class,"container")]//div[contains(@class,"logo")]//a[contains(@class,"logo-")]',
        'attr': 'div'
    }]
};/** Generated CJS end **/ 
}